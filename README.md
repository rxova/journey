...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------- | -------------------------- |
| 🤖 [`@rxova/journey-core`](https://www.npmjs.com/package/@rxova/journey-core)                       | ![version](https://img.shields.io/npm/v/@rxova/journey-core?color=0f8f6a&label=)            | ![5.4 kB](https://img.shields.io/badge/5.4%20kB-0f8f6a) | Framework-agnostic runtime |
| ⚛️ [`@rxova/journey-react`](https://www.npmjs.com/package/@rxova/journey-react)                     | ![version](https://img.shields.io/npm/v/@rxova/journey-react?color=0f8f6a&label=)           | ![6.3 kB](https://img.shields.io/badge/6.3%20kB-0f8f6a) | Typed React bindings       |
