...
- **Linear has an escape hatch.** Occasional `goToStepById` jumps are allowed and ungated. When
  named jumps or branching become normal behavior, convert the definition to graph mode.
