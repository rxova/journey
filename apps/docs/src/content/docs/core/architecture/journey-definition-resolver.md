...
- Read [Send Pipeline](./send.md) to see how the ordered transition list is consumed.
- Read [Transitions Syntax](../api/transitions-syntax.md) for the public authoring shapes this file accepts.
- Read [Quickstart](../getting-started.md) if you want to compare the normalized behavior with authored
  examples.
