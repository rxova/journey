...
- Read [Journey Definition Resolver](./journey-definition-resolver.md) for the normalization step
  this file depends on.
- Read [Runtime Queue](./runtime.md) for the state container this file creates.
- Read [Plugin Lifecycle](./plugin-controller.md) for hydration and machine augmentation.
- Read [Core API Overview](../api/overview.md) or [Quickstart](../getting-started.md) if you want to switch back
