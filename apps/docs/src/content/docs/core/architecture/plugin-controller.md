...
- Read [createJourneyMachine](./create-journey-machine.md) to see when plugin setup runs.
- Read [Plugins Overview](../plugins/overview.md) for the public extension model.
- Read [Persistence](../persistence.md) and [Execution Paths Plugin](../plugins/execution-paths-plugin.md)
