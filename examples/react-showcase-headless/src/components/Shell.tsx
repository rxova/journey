  ...
  return (
    <div className="layout">
      <header className="hero">
        <h1>
          React Showcase: Headless Mode <span className="badge badge-headless">HEADLESS</span>
        </h1>
        <p>
          React headless Vite example. No transitions are defined, so all navigation uses
          goToStepById.
        </p>
      </header>
