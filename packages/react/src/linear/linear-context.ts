...
export const LinearJourneyContext = /*#__PURE__*/ React.createContext<LinearJourneyMachine | null>(
  null
);
...
export const useLinearJourneyContext = (hookName: string): LinearJourneyMachine => {
  const machine = React.useContext(LinearJourneyContext);
  if (machine === null) {
    throw new Error(
