...
- c7883a5: This release includes two core changes.
...
- ee3160a: Remove the exported Journey runtime constants from `@rxova/journey-core` and simplify the related public types.
...
- e5c3447: Refactor the journey machine into smaller internal runtime, async-state, navigation, send, and control modules so the implementation is easier to read and maintain while preserving the existing public API and runtime behavior.
